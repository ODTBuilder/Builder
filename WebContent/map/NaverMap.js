...
OpenLayers.Layer.Naver = OpenLayers.Class(OpenLayers.Layer.XYZ, {
	...
	name : "NaverMap",
	url : [
	       	"http://onetile1.map.naver.net/get/95/0/0/${z}/${x}/${y}/bl_vc_bg/ol_vc_an",
	       	"http://onetile2.map.naver.net/get/95/0/0/${z}/${x}/${y}/bl_vc_bg/ol_vc_an",
	       	"http://onetile3.map.naver.net/get/95/0/0/${z}/${x}/${y}/bl_vc_bg/ol_vc_an",
	       	"http://onetile4.map.naver.net/get/95/0/0/${z}/${x}/${y}/bl_vc_bg/ol_vc_an"
	       ],
	       ...
	       attribution : '<a href="http://www.nhncorp.com" target="_blank" style="text-decoration: none !important;">© <span style="display: inline; font-family: Tahoma,sans-serif !important; font-size: 9px !important; font-weight: bold !important; font-style: normal !important; color: #009BC8 !important; text-decoration: none !important;">'
			...
			maxResolution : 2048,
			units : "m",
			//projection : new OpenLayers.Bounds(90112, 1192896, 1990673, 2761664),
