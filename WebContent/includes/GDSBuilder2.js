...
OpenLayers.GDSBuilder2 = OpenLayers.GDSBuilder2 || {};

OpenLayers.GDSBuilder2 = OpenLayers.Class({
  ...
  // OPTIONS
    ...
    initialize: function(name, options) {
        ...
        console.log("3차원 모드 준비 되었슴");
        this.init3DMode(window.innerWidth, window.innerHeight);
        //console.log(this.renderer);
        this.render();
    },
    
    //Insert by RS
    init3DMode: function(_width, _height){
    	console.log('initilizer : 3D mode has begined');
		...
		var cube = new THREE.Mesh( new THREE.BoxGeometry(100, 100, 10) , material);
		cube.position.z = 5;
    ...
    */
    ...
    redraw: function() {
        ...
        if (this.map) {
            ...
            //console.log(extent);
            //console.log(this.numZoomLevels);
